...
import { listDocuments, setDocument, deleteDocument } from "@aritrips/data";
...
export async function GET(request: NextRequest) {
  ...
  // Sin índice/query compuesta — la lista de favoritos de una sola persona
  // siempre es chica, filtrar del lado del servidor alcanza (mismo criterio
  // ya usado en las páginas de admin que listan y filtran en memoria).
  const docs = await listDocuments("favorites", credentials);
